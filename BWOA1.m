%--------------------
% BWOA combining with condition 1 to solve pb ODSTCA. 
%--------------------
function [leader_score_bwoa, leader_pos_bwoa, leader_pos_woa, conver_curve, conver_curve_woa, no_WOA_run, time] = BWOA(functionName, doTol, noSearchAgents, noUsers, noSubcs, maxIter, fobj_bwoa, lb_woa, ub_woa, fobj_woa)
tic 
	% initialization ======
