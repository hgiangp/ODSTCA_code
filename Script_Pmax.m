...
po_ODSTCA = zeros(length(PMax), noRealizations);
su_ODSTCA = zeros(length(PMax), noRealizations);
...
save('pmaxcom.mat', 'PMax', 'xt', 'po_ALCA', 'po_ODSTCA', 'po_ARJOA', 'po_IOJOA', 'po_OFDMA', ...
...
grid on
box on
set(gca, 'FontSize', 20, 'XLim', [1 length(PMax)]);
xticks = 1:length(PMax);
...
grid on
box on
set(gca, 'FontSize', 17.5, 'XLim', [1 length(PMax)], 'YLim', [2 Inf]);
xticks = 1:length(PMax);
set(gca, 'xtick', xticks);
set(gca, 'xticklabel',xt)
...
hold
savefig(h3, 'pmaxcom_su')

h2 = figure(2)
hold on
plot(1:length(PMax), po_ODSTCA(1:length(PMax)), 'b-o', 'linewidth', 2.0, 'markers', 13.0);
plot(1:length(PMax), po_ARJOA(1:length(PMax)), 'g-v', 'linewidth', 2.0, 'markers', 13.0);
plot(1:length(PMax), po_IOJOA(1:length(PMax)), 'k-x', 'linewidth', 2.0, 'markers', 13.0);
plot(1:length(PMax), po_OFDMA(1:length(PMax)), 'r-s', 'linewidth', 2.0, 'markers', 13.0);
%plot(1:length(po_ALCA), po_ALCA(1:length(po_ALCA)), 'k-d', 'linewidth', 2.0, 'markers', 13.0);
grid on
box on
set(gca, 'FontSize', 20, 'XLim', [17.0 inf]);
% xticks = 1:length(PMax);
set(gca, 'xtick', xticks);
set(gca, 'xticklabel',xt)
ylabel('Offloading Percentage');
...
h3 = figure(3)
hold on
plot(1:length(PMax), su_ODSTCA(1:length(PMax)), 'b-o', 'linewidth', 2.0, 'markers', 13.0);
plot(1:length(PMax), su_ARJOA(1:length(PMax)), 'g-v', 'linewidth', 2.0, 'markers', 13.0);
plot(1:length(PMax), su_IOJOA(1:length(PMax)), 'k-x', 'linewidth', 2.0, 'markers', 13.0);
plot(1:length(PMax), su_OFDMA(1:length(PMax)), 'r-s', 'linewidth', 2.0, 'markers', 13.0);
% plot(1:length(su_ALCA), su_ALCA(1:length(su_ALCA)), 'k-d', 'linewidth', 2.0, 'markers', 13.0);
grid on
box on
set(gca, 'FontSize', 17.5, 'XLim', [1 inf], 'YLim', [2.3 Inf]);
xticks = 1:length(PMax);
set(gca, 'xtick', xticks);
set(gca, 'xticklabel',xt)
ylabel('System Utility');
