...
%==========================================================================
function [hArray, dArray, UE_position] = channelModel(N, S, cellRadiusMax, cellRadiusMin, logNormalMean, logNormalDeviation)
% clc
% close all
